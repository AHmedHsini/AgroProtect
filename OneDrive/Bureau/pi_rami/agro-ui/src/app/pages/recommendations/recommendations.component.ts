  ...
  template: `
    <div class="min-h-screen bg-bg-base p-8 relative overflow-hidden">
      <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl font-black">Recommandations</h1>
      </div>
      ...
      <div class="glass-card flex flex-col items-center justify-center p-20 text-center">
        <div class="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mb-6">
          <lucide-icon name="star" class="w-12 h-12 text-primary"></lucide-icon>
        </div>
        <h2 class="text-2xl font-bold mb-4">Module en construction</h2>
        <p class="text-muted-foreground max-w-md">
          La page détaillée des recommandations de cultures est en cours de développement. Vous pouvez consulter l'aperçu depuis le tableau de bord.
        </p>
      </div>
    </div>
  `
