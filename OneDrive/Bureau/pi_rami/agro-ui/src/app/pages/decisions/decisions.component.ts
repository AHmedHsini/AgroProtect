  ...
  template: `
    <div class="min-h-screen bg-bg-base p-8 relative overflow-hidden">
      <div class="flex items-center gap-4 mb-8">
        ...
        <h1 class="text-3xl font-black">Décisions IA</h1>
      </div>
      ...
      <div class="glass-card flex flex-col items-center justify-center p-20 text-center">
        <div class="w-24 h-24 bg-primary/10 rounded-full flex items-center justify-center mb-6">
          <lucide-icon name="shield" class="w-12 h-12 text-primary"></lucide-icon>
        </div>
        <h2 class="text-2xl font-bold mb-4">Historique des décisions</h2>
        <p class="text-muted-foreground max-w-md">
          Cette page listera bientôt toutes les décisions (Financer, Surveiller, Refuser) avec un système de filtrage et d'export.
        </p>
      </div>
    </div>
  `
