...
import tn.esprit.agroprotect.identity.config.JwtConfig.JwtProperties;
...
/**
 * JWT Token Provider using HMAC algorithm for development.
 * 
 * SECURITY CONSIDERATIONS:
 * - Uses HMAC (symmetric) for simplicity in development
