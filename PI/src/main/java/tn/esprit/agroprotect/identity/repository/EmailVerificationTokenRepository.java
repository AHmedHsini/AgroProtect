...
import tn.esprit.agroprotect.identity.entity.EmailVerificationToken;
...
public interface EmailVerificationTokenRepository extends JpaRepository<EmailVerificationToken, Long> {
    ...
    @Query("SELECT t FROM EmailVerificationToken t WHERE t.tokenHash = :tokenHash AND t.used = false AND t.expiresAt > :now")
